  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add/Edit book <i class="fa fa-book"
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" id="username" name="username" required="required" placeholder="Masukan ISBN">
            </div>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Nama Buku:</label>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fa fa-book"
                    aria-hidden="true"></i></span>
              </div>
              <input type="text" class="form-control" id="email" name="email" required="required" placeholder="Masukan Nama Buku">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input type="phone" class="form-control" id="phone" name="phone" required="required" maxLength="100"
                minLength="0" placeholder="Masukan Pengarang">
            </div>
          </div>
          <div class="form-group">
